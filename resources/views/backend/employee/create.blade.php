                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="firstname" placeholder="{{__('lang.firstname')}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="bod" placeholder="{{__('lang.bod')}}">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="sex" style="width: 100%;">
                                  <option value="1">{{__('lang.man')}}</option>
                                  <option value="2">{{__('lang.woman')}}</option>
                              </select>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="start_date" placeholder="{{__('lang.start_date')}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="end_date">{{__('lang.end_date')}}</label>
                            <input type="date" class="form-control" name="end_date" placeholder="{{__('lang.end_date')}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mar_name" placeholder="{{__('lang.marriesname')}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mar_work" placeholder="{{__('lang.mar_work')}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="mar_address">{{__('lang.mar_address')}}</label>
                            <input type="text" class="form-control" name="mar_address" placeholder="{{__('lang.mar_address')}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mar_phone" placeholder="{{__('lang.mar_phone')}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
