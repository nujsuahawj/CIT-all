      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            ...
            <form method="POST" action="{{route('solution_type.store')}}">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_la" placeholder="{{__('blog.solution_type')}}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_en" placeholder="{{__('blog.solution_type')}}">
                      </div>
                    </div>
                  </div>
                </div>
