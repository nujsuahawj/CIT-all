            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{route('solutions.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-add"></i>{{__('lang.add')}}</a>
                </div>
                <div class="card-body">
                      ...
                      <td style="text-align: center">
                        <form action=" {{ route('solutions.destroy', $item->id) }} " method="POST">
                          ...
                          @method('DELETE')
                            ...
                            <a href="{{ route('solutions.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
