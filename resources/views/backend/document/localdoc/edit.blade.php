          ...
          <div class="card card-default">
            ...
            <form method="POST" action="{{route('local_doc.update', $local_doc->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date" value="{{$local_doc->date}}" placeholder="{{__('lang.date')}}">
                        </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="short_title" value="{{$local_doc->short_title}}" placeholder="{{__('lang.short_title')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="storage_file_id" style="width: 100%;">                    
                                  @foreach($storage as $store)
                                    <option 
                                    @if($local_doc->storage_file_id == $store->id)
                                        {{'selected'}}
                                    @endif
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-warning" href="{{route('local_doc.index')}}" >{{__('lang.back')}}</a>
                </div>
            </form>
