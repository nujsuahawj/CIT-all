            ...
            <form method="POST" action="{{route('position.update', $position->id)}}">
                ...
                <div class="card-body">
                    <div class="form-group">
                      <label for="name">{{__('lang.positionname')}}</label>
                      <input type="text" class="form-control" name="name" value="{{$position->name}}" placeholder="{{__('lang.positionname')}}">
                    </div>
                </div>
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">{{__('lang.save')}}</button>
                    <a class="btn btn-warning" href="{{route('position.index')}}" >{{__('lang.back')}}</a>
                </div>
            </form>
          </div>
        </div>
