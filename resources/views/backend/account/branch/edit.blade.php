            ...
            <form method="POST" action="{{route('branch.update', $branch->id)}}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code" value="{{$branch->code}}" placeholder="{{__('lang.code')}}">
                    </div>
                    <div class="form-group">
                      <label for="name">{{__('lang.name')}}</label>
                      <input type="text" class="form-control" name="name" value="{{$branch->name}}" placeholder="{{__('lang.name')}}">
                    </div>
                    <div class="form-group">
                        <label for="code">{{__('lang.address')}}</label>
                        <input type="text" class="form-control" name="address" value="{{$branch->address}}" placeholder="{{__('lang.address')}}">
                    </div>
                    <div class="form-group">
                      <label for="name">{{__('lang.phone')}}</label>
                      <input type="text" class="form-control" name="phone" value="{{$branch->phone}}" placeholder="{{__('lang.phone')}}">
                    </div>
                </div>
